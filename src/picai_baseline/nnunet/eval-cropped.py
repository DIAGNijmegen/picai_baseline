...
for fold in range(5):
    ...
    for checkpoint in checkpoints:
        ...
        metrics_path = softmax_dir.parent / f"metrics-{checkpoint}-picai_eval-{threshold}-cropped20x384x384.json"
        ...
        metrics = evaluate_folder(
            ...
            y_det_postprocess_func=lambda pred: extract_lesion_candidates_cropped(pred, threshold=threshold),
